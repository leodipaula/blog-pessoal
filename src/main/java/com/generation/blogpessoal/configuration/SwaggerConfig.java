...
public class SwaggerConfig {
        ...
        OpenAPI springBlogPessoalOpenAPI() {
                return new OpenAPI().info(new Info().title("Projeto Blog Pessoal").description(
                                "Projeto Blog Pessoal feito durante o curso da Generation Brasil")
                                .version("v0.0.1")
                                .license(new License().name("Leonardo de Paula")
                                                .url("https://leodipaula.github.io/leodipaula/"))
                                .contact(new Contact().name("Leonardo de Paula")
                                                .url("https://github.com/leodipaula")
                                                .email("leofernandes9@gmail.com")))
                                .externalDocs(new ExternalDocumentation().description("Github")
                                                .url("https://github.com/leodipaula/blog-pessoal"));
        }
                ...
                return openApi -> {
                        openApi.getPaths().values().forEach(
                                        pathItem -> pathItem.readOperations().forEach(operation -> {
                                                ...
                                                apiResponses.addApiResponse("500",
                                                                createApiResponse(
                                                                                "Erro na Aplicação!"));
